...
const portfolioItems = [
  ...
  },
  {
    ...
    title: '팀 프로젝트 자체 제작 브랜드 에끌라 아이웹',
  ...
  },
  {
    ...
    title: '개인프로젝트 캘빈클라인 브랜드 리뉴얼 웹',
    description: '디자인 및 웹 버전 구현하였습니다',
    filter: 'filter-personal',
    link: 'https://gominseo-calvinklein.vercel.app/',
  },
  {
    imgSrc: '/img/portfolio/ck.png',
    title: '개인프로젝트 캘빈클라인 브랜드 리뉴얼 그누보드',
    description: '디자인 및 그누보드플랫폼과 닷홈 도메인 활용하여 구현하였습니다',
    filter: 'filter-personal',
    link: 'http://gominseo.dothome.co.kr/ck/',
  },
  {
    imgSrc: '/img/portfolio/ck.png',
    title: '개인프로젝트 캘빈클라인 브랜드 리뉴얼 카페24',
    description: '디자인 및 카페24 솔루션 활용하여 구현하였습니다',
    filter: 'filter-personal',
